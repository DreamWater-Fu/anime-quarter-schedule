...
- `とある科学の超電磁砲T` / `某科学的超电磁炮 第3期` 已确认绑定 Bangumi TV subject `262940`; 长门有C 标题可能写作 `とある科学の超電磁砲レールガンT.` 并导致普通标题匹配漏配, 后续应走显式规则
...
- `斉木楠雄のψ難 Ψ始動編`, `ポケモン ソード・シールド 薄明の翼`, `ベイブレードバースト スパーキング`, `四月一日さん家と 第2期`, `おーばーふろぉ` 已在 2020 年 1 月/4 月缺 subject 排查中按 WEB/配信、VTuber 情景剧或成人向风险从可展示缓存删除, 后续不得为了补 subjectId 强行当作 TV 动画绑定
